...
class ImageUpload extends React.Component {
  ...
  _copyToClipboard = () => {
    ...
    firebase.database().ref('link/S4mca').set({link : this.state.image})
  };
...
const S4mca = createBottomTabNavigator({
...
export default createAppContainer(S4mca);
