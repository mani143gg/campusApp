...
class ImageUpload extends React.Component {
  ...
  _copyToClipboard = () => {
    ...
    firebase.database().ref('link/S5mca').set({link : this.state.image})
  };
...
const S5mca = createBottomTabNavigator({
...
export default createAppContainer(S5mca);
